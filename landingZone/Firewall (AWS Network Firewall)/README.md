...
## Composant Landing Zone - Firewall (AWS Network Firewall)
### Version: v1.2

## Rôle du composant
Solution de sécurité réseau native pour AWS, offrant une visibilité et un contrôle granulaires sur le trafic entrant, sortant et interne (Est-Ouest) du cloud.
